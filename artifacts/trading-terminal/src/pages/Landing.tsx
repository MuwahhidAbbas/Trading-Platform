  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground selection:bg-primary/30">
      <div className="max-w-5xl mx-auto px-6 py-24 flex flex-col gap-24">
        ...
        {/* Hero */}
        <div className="flex flex-col gap-8 max-w-3xl animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <div className="pt-4">
            <Link href="/terminal" className="inline-flex items-center gap-3 bg-white text-black px-6 py-3 text-sm font-medium hover:bg-white/90 transition-colors">
